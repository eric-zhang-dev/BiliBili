...
//
//
//class BedInfoAdapter(private val context: Context) : BaseAdapter() {
//    private val datas = ArrayList<BedInfo>()
//
...
//    }
//
//    fun setData(data: MutableList<BedInfo>) {
//        datas.clear()
//        datas.addAll(data)
...
//        holder.textView.text = bed.bed_name
//        return convertView
//    }
//
