...
data class Archives(var aid:String,var videos:Int,var tid:Int,var tname:String,var copyright:Int,var pic:String,var title:String,
                    var attribute:Int,var duration:Int,var rights:Rights,var stat:Stat,var play:Int,var favorites:Int,
...
data class Stat(var aid:String,var view:Int,var danmaku:Int,var reply:Int,var favorite:Int,var coin:Int,var share:Int,var now_rank:Int,var his_rank:Int,var like:Int)
